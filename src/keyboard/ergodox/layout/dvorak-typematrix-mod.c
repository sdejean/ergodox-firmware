...
// left hand
  ...
  _tab,       _quote,     _comma,     _period,    _P,     _Y, _grave,
  _shiftL,    _A,         _O,         _E,         _U,     _I,
  _ctrlL,     _semicolon, _Q,         _J,         _K,     _X, _bs,
  _guiL,      _capsLock,  _capsLock,  _pause,     _altL,
                                                  _ins,   _home,
                                      0,          0,      0,
                                      _space,     _pageU, 2,
// right hand
  _bracketR,  _6,       _7,    _8,     _9,      _0,    _print,
  _backslash, _F,       _G,    _C,     _R,      _L,    _slash,
              _D,       _H,    _T,     _N,      _S,    _dash,
  _bs,        _B,       _M,    _W,     _V,      _Z,    _equal,
                        _altR,  _ctrlR, _shiftR, _menu, _guiR,
_end,         _del,
1,            0,        0,
1,            _pageD,   _enter ),
...
// left hand
  ...
  0,          0,          0,         0,         0,
                                                         ...
                                                         0,  0,  0,
// right hand
_F7,       _F8,    _F9,       _F10,       _F11,         _F12,   _power,
